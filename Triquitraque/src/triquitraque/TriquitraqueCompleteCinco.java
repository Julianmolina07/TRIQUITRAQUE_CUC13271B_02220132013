...
public class TriquitraqueCompleteCinco extends javax.swing.JFrame {
    
    Color colorX;
    Color colorO;
    
    public TriquitraqueCompleteCinco() {
        initComponents();
        this.setLocationRelativeTo(null);
    }
    
    private TriquitraqueCincoPorCinco TriquitraqueCincoPorCinco;
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        String nombreX = txtNombreX.getText();
        String nombreO = txtNombreO.getText();
        TriquitraqueCincoPorCinco CpC = new TriquitraqueCincoPorCinco();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TriquitraqueCompleteCinco().setVisible(true);
            }
        });
    }
