...
public class TriquitraqueCompleteTres extends javax.swing.JFrame {
    
    Color colorX;
    Color colorO;
    
    public TriquitraqueCompleteTres() {
        initComponents();
        this.setLocationRelativeTo(null);
    }
    
    private TriquitraqueTresPorTres TriquitraqueTresPorTres;

    public void actualizarTriquitraqueTresPorTres() {
        
        String nombreX = txtNombreX.getText();
        String nombreO = txtNombreO.getText();
        TriquitraqueTresPorTres.setlbturno1Text(nombreX);
        TriquitraqueTresPorTres.setlbturno2Text(nombreO);
    }
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        String nombreX = txtNombreX.getText();
        String nombreO = txtNombreO.getText();
        TriquitraqueTresPorTres TPT = new TriquitraqueTresPorTres();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TriquitraqueCompleteTres().setVisible(true);
            }
        });
    }
